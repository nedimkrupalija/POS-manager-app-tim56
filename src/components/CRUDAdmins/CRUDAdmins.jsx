...
const CRUDAdmins = () => {
  ...
  const fetchAdmins = async () => {
    try {
        const headers = {
            'Authorization': eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoic3VwZXJhZG1pbiIsInVzZXJuYW1lIjoibmVkYSIsImlhdCI6MTcxMjA5NTQwNywiZXhwIjoxNzEyMTAyMzk5fQ._zMU0pk_jLiE8BEERwEXMAOULV5O1bAtkdJf98yfakQ
        };
